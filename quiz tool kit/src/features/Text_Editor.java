...
{
dispose();
Text_Editor note1 = new Text_Editor("Untitled-Notepad");
...
public String OpenTextEditor(){
	Text_Editor note = new Text_Editor("Untitled-Notepad");
	note.setSize(500,500);
	note.setVisible(true);
	return"Text Editor Open";
